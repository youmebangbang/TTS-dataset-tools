...
def create_hparams(hparams_string=None, verbose=False):
    ...
    hparams = HParams(
        ...
        training_files='filelists/David_Attenborough_v4_prepped.csv',
        validation_files='filelists/David_Attenborough_v4_val.csv',
        ...
        p_decoder_dropout=0.1, #change to 0 when doing inference
